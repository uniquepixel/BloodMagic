...
/**
 * Full-fidelity port of 1.20.1's {@code ItemSentientPickaxe} - see {@link SentientSwordItem} for
 * the overall design notes shared by all five Sentient tools.
 */
public class SentientPickaxeItem extends PickaxeItem implements IWillDropWeapon {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        SentientTooltipHelper.appendSentientTooltip(tooltip, "tooltip.bloodmagic.sentient_pickaxe.desc", type, level, SentientToolHelper.getExtraDamage(type, level, false), SentientToolHelper.getDigSpeedBonus(level), will);
