...
/**
 * Full-fidelity port of 1.20.1's {@code ItemSentientAxe} - see {@link SentientSwordItem} for the
 * overall design notes shared by all five Sentient tools.
 */
public class SentientAxeItem extends AxeItem implements IWillDropWeapon {
    private static final double BASE_ATTACK_DAMAGE = 8;
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        SentientTooltipHelper.appendSentientTooltip(tooltip, "tooltip.bloodmagic.sentient_axe.desc", type, level, SentientToolHelper.getExtraDamage(type, level, false), SentientToolHelper.getDigSpeedBonus(level), will);
